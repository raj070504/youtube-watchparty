    ...
    <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-6 space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 p-4 sm:p-5 bg-white rounded-2xl border border-slate-200 shadow-sm">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1 text-xs text-slate-500 font-medium">
              ...
              <button
                ...
                className="flex items-center gap-1 font-mono font-bold text-slate-700 bg-slate-100 hover:bg-slate-200 rounded px-2 py-0.5 transition-colors"
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 sm:px-3.5 sm:py-2 bg-white hover:bg-slate-50 text-xs font-semibold text-slate-700 rounded-lg border border-slate-200 transition-all shadow-sm"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 py-1.5 sm:px-3 sm:py-2 bg-white hover:bg-rose-50 hover:text-rose-600 hover:border-rose-200 text-xs font-semibold text-slate-700 rounded-lg border border-slate-200 transition-colors shadow-sm"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-6 items-start">
        ...
        <div className="lg:col-span-8 space-y-4">
          ...
          <div className="relative overflow-hidden bg-black rounded-2xl border border-slate-800 shadow-xl aspect-video group w-full">
            {/* Embedded YouTube Player IFrame Target */}
            <div id="yt-player-container" className="w-full h-full" />

            {/* Connecting Overlay */}
            {loading && (
              <div className="absolute inset-0 z-30 bg-slate-900/50 backdrop-blur-sm flex flex-col items-center justify-center space-y-3">
                <div className="w-10 h-10 border-4 border-indigo-500/20 border-t-indigo-500 rounded-full animate-spin" />
                <p className="text-xs font-semibold text-white/90 tracking-widest uppercase">Connecting...</p>
              </div>
            )}
